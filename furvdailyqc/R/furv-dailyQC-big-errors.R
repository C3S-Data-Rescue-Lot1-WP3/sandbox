...
#' (RR) values, reports RR, and Tmax and Tmin values exceeding thresholds selected
#' by the suer.The output is a list with the days in which RR or Tmax or Tmin exceeds
#' these thresholds.
#'
...
#'
#'   Output: writes a list with suspicious values in <out_of_range.txt>;
